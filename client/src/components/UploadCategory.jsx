...
import { createCategory, getCategory } from "../store/categorySlice.js"
import { IoClose } from "react-icons/io5";

function UploadCategory({closeCategory}) {
    ...
    <section className="fixed inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm z-50 p-3">
       <div className="bg-white  w-full max-w-3xl p-4 rounded-lg shadow-lg">
         <div className="flex justify-between items-center">
             ...
             <button onClick={closeCategory} className="cursor-pointer hover:text-primary-200">
         ...
         <form onSubmit={handleSubmit(onSubmit)}>
            <div className="p-3">
                 <div className="relative w-35 h-45 mx-auto m-8">
                    {selectedImage ? (
                      <img
                        className="w-full h-full object-cover rounded border-3 border-gray-300"
                        src={selectedImage}
